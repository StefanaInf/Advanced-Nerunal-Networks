...
optimized_transforms = v2.Compose([
    v2.Resize(36),
    v2.CenterCrop(32),
    v2.ToImage(),
...
train_set = CIFAR100('/kaggle/input/fii-atnn-2024-assignment-2', download=False, train=True, transform=optimized_transforms)
test_set = CIFAR100('/kaggle/input/fii-atnn-2024-assignment-2', download=False, train=False, transform=optimized_transforms)
