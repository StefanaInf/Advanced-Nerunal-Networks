...
train_set = CIFAR100('/kaggle/input/fii-atnn-2024-assignment-2', download=False, train=True,
                     transform=optimized_transforms)
test_set = CIFAR100('/kaggle/input/fii-atnn-2024-assignment-2', download=False, train=False,
                    transform=optimized_transforms)
...
optimizer = optim.SGD(model.parameters(), lr=0.0001, fused=True)
